// Alerts and notifications fixture data

export type AlertSeverity = 'critical' | 'warning' | 'info' | 'success'
export type AlertCategory = 'equipment' | 'safety' | 'production' | 'personnel' | 'system'
...
export const alertsData: Alert[] = [
  ...
  },
  {
    ...
    message: 'Hokusai Volcanic Rift surface temperature exceeds safe operating limits (445°C)',
...
export function getRecentAlerts(count: number = 10): Alert[] {
  return [...alertsData]
...
export function getCommodityTrendColor(trend: 'up' | 'down' | 'stable'): string {
  switch (trend) {
    case 'up':
